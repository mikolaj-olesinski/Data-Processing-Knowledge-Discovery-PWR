...
1. W tym repozytorium będziemy zamieszczać rozwiązania do list **3-6**.
...
4. Tworzymy pull request `main` <- `[nazwa brancha]` i nazywamy go: `lista 3`, `lista 4`, `lista 5`, `lista 6`. 
